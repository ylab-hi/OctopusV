...
def bench(
        ...
        size_max: int = typer.Option(
            50000, "--size-max", help="Maximum variant size to consider (default: 50000)"
        ),
    ...
    try:
        ...
        typer.echo(f"Error during benchmarking: {str(e)}", err=True)
